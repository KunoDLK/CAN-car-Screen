...
#define UIType_Dial 1
#define UIType_BarGraph 2
...
DataPoint Dials[6] =
{
  {0, 1, -18, 124, 1, 95, 105, UIType_Dial, 130, 85, {'O', 'I', 'L', ' ', '(', 186, 'C', ')'}},
  {0, 1, -18, 124, 1, 95, 105, UIType_Dial, 307, 85, {'C', 'O', 'L', 'N', 'T', ' ', '(', 186, 'C', ')'}},
  {0, 1, 0, 8000, 0, 5000, 6500, UIType_Dial, 130, 245, {'E', 'N', 'G', 'I', 'N', 'E'}},
  {0, 1, 0, 8000, 0, 5000, 6500, UIType_Dial, 307, 245, {'T', 'R', 'A', 'N', 'S'}},
  {0, 1, 0, 99.9, 2, 33, 66, UIType_Dial, 130, 408, {'S', 'P', 'E', 'E', 'D'}},
  {0,  0, 0, 60,  1, 60 , 60, UIType_Dial, 307, 408, {'F', 'P', 'S'}}
};
...
DataPoint Bars[5] =
{
  ...
  {25, 0, 0, 100, 1, 33  , 66,  UIType_BarGraph, 520, 40, {'T', 'H', 'R', 'L'}},
  {50, 0, 0, 100, 1, 33  , 66,  UIType_BarGraph, 580, 40, {'T', 'H', 'R', 'L'}},
  {75, 0, 0, 100, 1, 33  , 66,  UIType_BarGraph, 640, 40, {'T', 'H', 'R', 'L'}},
